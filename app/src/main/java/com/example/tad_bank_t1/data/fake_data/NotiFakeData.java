...
//            new Notification("user1", "Bien dong 1", "Bạn đã chuyển 500.000đ cho Nguyễn Văn A.", NotificationType.TRANSACTION, new Date()),
//            new Notification("user2", "Bien dong 2", "Bạn đã chuyển 500.000đ cho Nguyễn Văn A." +
//                    "Bạn đã chuyển 500.000đ cho Nguyễn Văn A." +
//                    "Bạn đã chuyển 500.000đ cho Nguyễn Văn A." +
//                    "Bạn đã chuyển 500.000đ cho Nguyễn Văn A.", NotificationType.TRANSACTION, new Date()),
//            new Notification("user3", "Bien dong 3", "Bạn đã chuyển 500.000đ cho Nguyễn Văn A." +
//                    "Bạn đã chuyển 500.000đ cho Nguyễn Văn A." +
//                    "Bạn đã chuyển 500.000đ cho Nguyễn Văn A.", NotificationType.TRANSACTION, new Date()),
//            new Notification("user4", "Bien dong 4", "Bạn đã chuyển 500.000đ cho Nguyễn Văn A.", NotificationType.SYSTEM, new Date()),
//            new Notification("user5", "Bien dong 5", "Bạn đã chuyển 500.000đ cho Nguyễn Văn A. So du hien tai la 1000000", NotificationType.SYSTEM, new Date()),
//            new Notification("user6", "Bien dong 6", "Bạn đã chuyển 500.000đ cho Nguyễn Văn A.", NotificationType.SYSTEM, new Date())
    );
